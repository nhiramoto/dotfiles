...
local thistheme_path = themes_path .. "/aura"
...
theme.bg_focus   = theme.color.purple
...
theme.border_marked = theme.color.orange
-- }}}
...
theme.bg_widget = theme.color.black
...
theme.graph_fg1 = theme.color.purple
theme.graph_fg2 = theme.color.blue
theme.graph_fg3 = theme.color.green
