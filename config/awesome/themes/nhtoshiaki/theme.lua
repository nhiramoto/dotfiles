...
theme.notification_font = theme.font_big
...
theme.notification_shape = function(cr, width, height)
    gears.shape.partially_rounded_rect(cr, width, height, true, false, true, true, 10)
end
-- }}}
...
-- {{{ Icons
-- {{{ Taglist
theme.taglist_squares_sel   = thistheme_path .. "/taglist/squarefz.png"
theme.taglist_squares_unsel = thistheme_path .. "/taglist/squarez.png"
