return {
  ...
  config = function()
    ...
    keyset("n", "gu", '<CMD>lua _G.show_docs()<CR>', {silent = true})
    ...
    keyset('n', '<leader>fe', '<cmd>CocCommand flutter.emulators<cr>', opts)
    keyset('n', '<leader>fd', '<cmd>CocCommand flutter.devices<cr>', opts)
    keyset('n', '<leader>fr', '<cmd>CocCommand flutter.run<cr>', opts)
    keyset('n', '<leader>fq', '<cmd>CocCommand flutter.dev.quit<cr>', opts)
    keyset('n', '<leader>fh', '<cmd>CocCommand flutter.dev.hotRestart<cr>', opts)
    keyset('n', '<leader>fl', '<cmd>CocCommand flutter.dev.openDevLog<cr>', opts)
  end
}
